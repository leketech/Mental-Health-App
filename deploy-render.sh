...
echo "   - Docker Command: docker-compose -f docker-compose.render.yml up"
echo "   - Instance Type: Free"
echo ""
echo "6. Add the following environment variables:"
echo "   - JWT_SECRET: [generate a strong secret - at least 32 characters]"
echo "   - PORT: 80"
echo ""
...
echo "   - Generate a strong JWT_SECRET (at least 32 characters)"
